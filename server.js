...
client.on("ready", () => {
  console.log("Activo");
  client.user.setPresence({activity: { name: 'Las Estrellas🌠✨', type: 'WATCHING' }, status: 'idle'})
  });
...
client.on('message', async message => {
  ...
  if(message.content.startsWith(`${prefix}rank`)) {
    ...
    const RankCard = new Canvacord.Rank()
      ...
      .setProgressBar ("#e5ddb9", "COLOR")
      .setOverlay ("#000000")
      .setUsername (user.username)
      .setDiscriminator (user.discriminator)
      .setBackground("IMAGE", "https://cdn.discordapp.com/attachments/735730825030795344/827665334684352522/9887226656997121937.png")
      RankCard.build()
      .then(data => {
